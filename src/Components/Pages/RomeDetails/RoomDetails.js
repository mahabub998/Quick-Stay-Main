...
import herobgImage from "../../../../src/Components/assets/images/herobgImage.jpg";
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { faCheckSquare, faCoffee,faMapMarker } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className="row mt-5 ">
          ...
          <div className=" col-md-3 shadow-lg p-3 mb-5 bg-white rounded">
            ...
            <div className="d-flex">
              <div>
                <h4>Private Room</h4>
                <small><FontAwesomeIcon icon={faMapMarker} /> sec,22 Chandigarh</small>
                <p>Full Furnished</p>
              </div>
          ...
          <div className=" col-md-3 shadow-lg p-3 mb-5 bg-white rounded">
            ...
            <div className="d-flex">
              <div>
                <h4>PG</h4>
                <small><FontAwesomeIcon icon={faMapMarker} /> sec,46 Chandigarh</small>
                <p>Full Furnished</p>
              </div>
              <div className="ms-auto">
                <p className="">Price:500</p>
